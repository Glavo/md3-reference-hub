...
[Workshop: Migrating to Variable Fonts](https://goo.gle/io22-variable-type-lab)

_Speaker: Ivy Knight_
...
_Speakers: Karen Ng, Julia Feldman_
...
[Create expressive and readable typography with variable fonts](https://goo.gle/io22-expressive-variable-type)

_Speakers: Sehee Lee, Tobias Kunisch, Michael Gilbert_
...
[Designing apps for large screens](https://goo.gle/io22-designing-large-screens)

_Speaker: André Labonté_
...
[Take a Flutter app from boring to beautiful](https://goo.gle/io22-flutter-beautiful)

_Speaker: Rody Davis_ 
...
[Codelab: Designing with accessible colors](https://codelabs.developers.google.com/color-contrast-accessibility)

Learn how to create a visually accessible theme and check color contrast using the Material Theme Builder.

[Codelab: Making accessible apps with Material 3 and Jetpack Compose](http://goo.gle/m3-compose-a11y)
...
[Codelab: Migrating to variable fonts](https://codelabs.developers.google.com/migrating-variable-fonts)

Get hands-on with this codelab, all about how to design and implement variable fonts using the Google Fonts API.

[Demo: Variable Fonts](https://goo.gle/about-variable-type)
...
Introduced in 2021, [I/O Adventure](https://io.google/2022/adventure/material) is a virtual world for attendees to chat with Googlers and other developers, explore Google product demos, earn badges, and more. We’ve reimagined the experience to highlight all the fantastic work the team has created this year. Be sure to say hello to FABio and check out the variable sculptures.

## See you there!

Subscribe to our Material Design [YouTube channel](https://youtube.com/MaterialDesign?sub_confirmation=1) and follow us on [Twitter](https://twitter.com/materialdesign) for the latest updates.
