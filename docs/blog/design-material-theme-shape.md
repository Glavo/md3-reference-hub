...
![Image](../../assets/images/cc6476f2351b-eDkSmsI2fH-LaxjLooxE4US4WlJ2RYul60PfZhunjsMlzTnp24gQv6_7u0D0Zzi9QGGWzf5x9xdr8H6pxFw3E6sXRKWntSKd.png)
...
![Android screen with bottom app bar and two cards containing images, title and secondary text](../../assets/images/8a80a3637a61-svJ4gR0Gwp_kcmdEJqpV3iZTIlNAdzRIqJDMKftCk-RI_k8PqDM6g9dZ5enKgQREdHxXnE77Jh-vQJmdu8GFG3vd1yoyAr4G.png)

Intentional use of shape can create visual hierarchy among components, separating content from key actions like the FAB.

![Backdrop pattern used to access the menu in the Shrine app](../../assets/images/1993a3ba366a-WcQwxd_ga2M5AuWK0jIhZRYQcAYnbmYgw2jf4wviVl22IIUnX2F98b8FeMdLzmaCqi33fbe00F-EBVwdwkAhTOeiG7-VplHU.png)

Shape can also suggest interactivity, hinting with an asymmetric corner that some affordance is present.

![Shrine logo and Shrine app screen. Tapping the logo reveals the backdrop](../../assets/images/005836f07157-_vqi2auEgDaEYP8D7CtLeqrED53qA5NRiXiuD6-oT9vPEFQwEXUSlL2pYBQvRuddSzClPQu2WHgWgfycddVObU3i6IRkYrur.png)
...
![9 shapes illustrating the range of shape options from very rounded to slightly rounded, sharp, and cut](../../assets/images/5026f817cedc-uD1MPmDKKNhbsryU05FrtMp2SMT-MQLiW6qtDIVerrNseseUhfww4IlsPyIoyWwyR60l4Dz44VKwLosQUkA6jviQ7_4fVpRV.png)
...
![Owl app logo and components including the top app bar, list, buttons, and cards](../../assets/images/9174fd40895b-E68r4iOW7KMBIODWuEqDwi7vDAaeX4ph4ly-cxjUV0Bl-_lXARgZA74fSanqBjbkqKv7ZL1j_QFemIKVDQ1qRV25xrEbmlcl.png)
...
![Shrine app logo and components including app bars, list, buttons, cards, and chips](../../assets/images/de07da1f672e-XO8SXbVc8ab0v5ZJX-jOT-XIB4iaMPmk5HzSliz9Rchm5orIsGYbOORj-PMZBQoiS6SDIotn5WhkY4qhcDcb4-Ysp0HSp9xV.png)
...
![Material baseline design kit in Figma showing button components and editing module](../../assets/images/abfa0ecc3c1d-R9_2KknIkD0kmFakfmticDs2sVV6Q4geuMY0512vJQSXintAh6PaIAsAUp2AdK44VcATD6bXHZcfbBwF5zyvHy0nqjyDHd18.png)
