...
![Carousel items adapting dynamically to device size by shrinking and reducing in number.](../../../assets/images/f1bf561ca3a6-lwusb1kq-1.png)
...
![Contained carousel with a large, medium, and small item. Text is hidden on the small item.](../../../assets/images/4038d91f833a-lwusbuoo-2.png)
...
![Multi-browse carousel with all images and text easily legible.](../../../assets/images/8bf1d3ef8df3-lwuscosc-3-do.png)

_Set the large carousel item size to ensure the images and text are easy to read and recognize_

![Multi-browse carousel with a very thin small item, making the image unrecognizable.](../../../assets/images/de3c3b569b9b-lwusd3wu-3-don't.png)
...
![Carousel on a phone. 2 large, 1 medium, and 1 small item are fully visible but thin. The items don't have text.](../../../assets/images/8cc6d2996eff-lwusga4v-6.png)
...
![An empty rectangle representing a carousel container.](../../../assets/images/37e31fc51335-lwusikhn-12.png)
...
![Contained carousel items with 5 lines of content: a title, a description, and a label.](../../../assets/images/d9ea342e700c-lwusmns4-16.png)
...
![8 carousel items visible at once on a tablet in landscape orientation.](../../../assets/images/bf073011795f-lwuso0q8-18.png)
...
![Full-screen carousel with items stopping halfway off screen once scrolled.](../../../assets/images/76b6e4d7d747-lwuspl2g-20-don't.png)
