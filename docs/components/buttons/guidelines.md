...
assets:
  ...
  - "assets/videos/2c4aa2d74057-mmlqnl0b-GM3-Commom-Buttons-Guidelines-02-v01.mp4"
  - "assets/images/97a40f731f30-mmlqpj6e-03-do.png"
  - "assets/images/07feae460184-mmlqpykn-04-don't.png"
  - "assets/images/96bdb978f87e-mmlqs2ix-05-do.png"
  - "assets/images/f5afdae867d8-mmlqslcx-06-do.png"
  - "assets/images/421921bbfbe0-mmlqt8jf-07-don't.png"
  - "assets/images/7986cdbc4e5f-mmlquaj1-08.png"
  - "assets/images/d09da5f17370-m3t81e1q-9.png"
  - "assets/videos/d566f4dd405d-mmlt2zdp-GM3-Commom-Buttons-Guidelines-10-v01.mp4"
  - "assets/images/fe44e50d7961-mmlt4ivd-11-do.png"
  - "assets/images/a85c65ef0715-mmlt52gk-12-dont.png"
  - "assets/images/12ac83a93e04-mmlt6b63-13.png"
  - "assets/images/5db5b145c527-mmlt7k3u-14-do.png"
  - "assets/images/cc12deb0a164-mmlt7yj0-15-dont.png"
  - "assets/images/6fa67a4ed709-mmlt97u1-16-caution.png"
  - "assets/images/412a425acc83-mmltabq2-17.png"
  - "assets/images/727f6dbde009-mmltba1r-18.png"
  - "assets/images/22da4fb36efb-mmltc6hg-19-do.png"
  - "assets/images/070174424563-mmltdu8d-20-dont.png"
  - "assets/images/5adce41e399b-mmltfge9-21-do.png"
  - "assets/images/fee67ae19c58-mmltfyz4-22-do.png"
  - "assets/images/2d99f7287291-mmlthjj7-23-do.png"
  - "assets/images/d185d4ecebc0-mmltnhb2-24-dont.png"
  - "assets/images/0c8832bb4b19-mmltof7i-25-dont.png"
  - "assets/images/870fa63f3693-mmltpyn5-26.png"
  - "assets/images/095c4c7a57f4-mmltrnw9-27-caution.png"
  - "assets/images/2ed92e399642-mmlz52ml-28.png"
  - "assets/images/6bcbb79207b0-mmlz6rew-29.png"
  - "assets/images/a6a677fa433a-mmm0gmxc-30.png"
  - "assets/images/7591049b8d19-mmm0loal-31.png"
  - "assets/images/af32105e8d06-mmm0mtua-32.png"
  - "assets/images/63bf794044cd-mmm0nymp-33-do.png"
  - "assets/images/6c8638f985c4-mmm0oqjx-34-caution.png"
  - "assets/images/7129edb770f4-mmm0q822-35.png"
  - "assets/images/447b0a013ec2-mmm0rpw4-36.png"
  - "assets/images/04b2172286d4-mmm0s6c1-37.png"
  - "assets/images/af3131a3f987-mmm0tlmd-38.png"
  - "assets/images/d5d1a8315545-mmm0v0go-39.png"
  - "assets/images/5322f8adc0eb-mmm0vwgx-41.png"
  - "assets/images/afb066a52816-mmm0wuqe-40.png"
  - "assets/images/f2f9ed8fe717-mmm0y1g6-42-do.png"
  - "assets/images/214b6fa5ad59-mmm0yith-43-dont.png"
  - "assets/images/4dd3b79b9b11-mmm0zsof-44-dont.png"
  - "assets/images/dff7435dbd1b-mmm11hfb-45.png"
---
...
![Buttons in various shapes and sizes.](../../../assets/images/d6beeee81d7c-mmlqkp7g-01.png)
...
![1 button placed on bottom right of screen.](../../../assets/images/97a40f731f30-mmlqpj6e-03-do.png)

_Use buttons for discrete actions_

![3 buttons side by side on bottom of screen.](../../../assets/images/07feae460184-mmlqpykn-04-don't.png)
...
![Filled button on menu screen.](../../../assets/images/96bdb978f87e-mmlqs2ix-05-do.png)

_A button container’s width is dynamically set to fit its label text_

![Filled button as wide as layout grid.](../../../assets/images/f5afdae867d8-mmlqslcx-06-do.png)

_Button container width can be responsive, which allows it to stretch horizontally_

![Filled button with label text overflowing the container. ](../../../assets/images/421921bbfbe0-mmlqt8jf-07-don't.png)
...
![Audio app with play, next, and back buttons.](../../../assets/images/d09da5f17370-m3t81e1q-9.png)
...
![Toggleable “start” and “reset” buttons.](../../../assets/images/fe44e50d7961-mmlt4ivd-11-do.png)

_When using toggleable buttons, keep the label character count a similar length for both states_

![Toggleable “start” and “reset back to beginning” buttons.](../../../assets/images/a85c65ef0715-mmlt52gk-12-dont.png)
...
![Button with label text “See all recipes.”](../../../assets/images/5db5b145c527-mmlt7k3u-14-do.png)

_Use sentence case for button label text, capitalizing the first word and proper nouns_

![Button with wrapped label.](../../../assets/images/cc12deb0a164-mmlt7yj0-15-dont.png)
...
![Chips next to an outlined button, highlighting their similarities.](../../../assets/images/6fa67a4ed709-mmlt97u1-16-caution.png)
...
![Round button.](../../../assets/images/412a425acc83-mmltabq2-17.png)
...
![Square buttons with different radii.](../../../assets/images/727f6dbde009-mmltba1r-18.png)

_Square buttons have square containers and change radius as the button size changes_

![Button with the label text “Edit playlist” within the container.](../../../assets/images/22da4fb36efb-mmltc6hg-19-do.png)

_A button’s width dynamically adjusts to the label text_

![Button with text larger than its container.](../../../assets/images/070174424563-mmltdu8d-20-dont.png)
...
![Filled button with the icon to the left of the label in a left-to-right language.](../../../assets/images/5adce41e399b-mmltfge9-21-do.png)

_Place the icon to the left of the label in buttons with text in left-to-right languages_

![Filled button with the icon to the right of the label in a right-to-left language.](../../../assets/images/fee67ae19c58-mmltfyz4-22-do.png)

_Place the icon to the right of the label in buttons with text in right-to-left languages_

![Button with shopping cart icon and text label “Add to cart”.](../../../assets/images/2d99f7287291-mmlthjj7-23-do.png)

_Use icons that clearly communicate their meaning_

![Button with Plus icon vertically above the text label “Add to watch list”.](../../../assets/images/d185d4ecebc0-mmltnhb2-24-dont.png)

_Don’t vertically align an icon and text in the center of a button_

![Button with two icons.](../../../assets/images/0c8832bb4b19-mmltof7i-25-dont.png)
...
![Elevated button on a scrim background.](../../../assets/images/870fa63f3693-mmltpyn5-26.png)
...
![Elevated button in a shopping experience.](../../../assets/images/095c4c7a57f4-mmltrnw9-27-caution.png)
...
![Filled button reading “Make payment.”](../../../assets/images/2ed92e399642-mmlz52ml-28.png)
...
![Filled “pause” button in a music app.](../../../assets/images/6bcbb79207b0-mmlz6rew-29.png)
...
![Shopping app with 2 tonal-style filled buttons.](../../../assets/images/a6a677fa433a-mmm0gmxc-30.png)
...
![Outlined buttons for less important actions, including a back button and a button that reads “Next movie.”](../../../assets/images/7591049b8d19-mmm0loal-31.png)
...
![Outlined button for “add to cart” in shopping app.](../../../assets/images/af32105e8d06-mmm0mtua-32.png)

_Outlined buttons display a stroke around the button container_

![Outlined button labeled Add to calendar on a pink/purple background.](../../../assets/images/63bf794044cd-mmm0nymp-33-do.png)

_Outlined buttons can be used on backgrounds with a color gradient_

![2 photos, each with an outlined button with a custom fill.](../../../assets/images/6c8638f985c4-mmm0oqjx-34-caution.png)
...
![Example calendar screen with 2 text buttons and 1 split button.](../../../assets/images/7129edb770f4-mmm0q822-35.png)
...
![Text button labeled “Retry” in a snackbar.](../../../assets/images/447b0a013ec2-mmm0rpw4-36.png)

_Text button in a snackbar_

![Text button labeled “View album” on an album cover background.](../../../assets/images/04b2172286d4-mmm0s6c1-37.png)

_Text button against an image background_

In cards, text buttons help maintain an emphasis on card content.

![Text button labeled “Learn more” in an information card about sourdough bread.](../../../assets/images/af3131a3f987-mmm0tlmd-38.png)
...
![Modal dialog with the title “Subscribe to our newsletter?” and trailing buttons “Cancel” and “Subscribe”.](../../../assets/images/d5d1a8315545-mmm0v0go-39.png)
...
![Flights app in compact screen with buttons below flight information.](../../../assets/images/5322f8adc0eb-mmm0vwgx-41.png)

_Filled buttons are end-aligned below flight information in a compact window_

![Flights app in large screen with buttons to the left of flight information.](../../../assets/images/afb066a52816-mmm0wuqe-40.png)
...
![2 buttons with horizontally centered text labels.](../../../assets/images/f2f9ed8fe717-mmm0y1g6-42-do.png)

_Keep the icon and label text grouped and centered_

![1 button with centered text label, 1 button with icon and label aligned to opposite edges.](../../../assets/images/214b6fa5ad59-mmm0yith-43-dont.png)
...
![Button width is over-stretched with screen width.](../../../assets/images/4dd3b79b9b11-mmm0zsof-44-dont.png)
...
![2 buttons scaling to accommodate different device sizes.](../../../assets/images/dff7435dbd1b-mmm11hfb-45.png)
