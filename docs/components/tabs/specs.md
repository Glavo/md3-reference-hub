...
_ContainerBadge (optional)Icon (optional)LabelDividerActive indicator_
...
_Primary tab color roles used for light and dark schemes:SurfacePrimaryPrimaryOn surface variantOn surface variantOutline variantPrimary_
...
_ContainerBadge (optional)LabelDividerActive indicator_
...
_Secondary tab color roles used for light and dark schemes:SurfaceOn surfaceOn surface variantOutline variantPrimary_
...
Container height (label text only)

48dp

Container height (icon and label text)
...
Active indicator minimum length

24dp

Padding between inline icon and text

8dp

Padding between inline text and badge

4dp

Overlap of badge on stacked icon
