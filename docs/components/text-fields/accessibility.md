...
assets:
  ...
  - "assets/images/76a9216b0a66-lx32f68l-2.png"
  - "assets/images/9280798ebe72-lx32k7wf-3.png"
  - "assets/images/1fa18834de38-lx32kef6-4.png"
  - "assets/images/d7832e08b0f6-lx32ks8b-5.png"
  - "assets/images/50d9b17f6521-lx32l5y8-6.png"
  - "assets/images/fc8ad7cfa039-lx32leg0-7.png"
  - "assets/images/0d54ecfc61ca-lx32lojq-8.png"
  - "assets/images/be83b2a6dc8b-lx32m4pa-9.png"
  - "assets/images/5044f9c5cfa9-lx32meu7-10.png"
  - "assets/images/7da5afd51a38-lx32mlzg-11.png"
---
...
![Filled text field in enabled (empty) state and in focused (populated state) have visual cues to identify their state.](../../../assets/images/2a1cbc7df27d-lx32f0bp-1.png)

_Filled text fields_

![Outlined text field in enabled (empty) state and in focused (populated state) have visual cues to identify their state.](../../../assets/images/76a9216b0a66-lx32f68l-2.png)
...
![The text field  and accessibility label both read “Email.” The role is “textbox.”](../../../assets/images/d7832e08b0f6-lx32ks8b-5.png)
...
![The trailing icon’s accessibility label “Show Password.” The role is “Button.”](../../../assets/images/50d9b17f6521-lx32l5y8-6.png)
...
![Text field accessibility labels “UI text” are “Euro” for a currency prefix and “At gmail dot com” for the email address suffix.](../../../assets/images/fc8ad7cfa039-lx32leg0-7.png)
...
![The text field accessibility labels is: UI text “Not a valid ZIP code.” The role is “Alert.”](../../../assets/images/0d54ecfc61ca-lx32lojq-8.png)
...
![A character counter's accessibility label  reads: UI text (“Character count, 5/20”)](../../../assets/images/be83b2a6dc8b-lx32m4pa-9.png)
...
![The accessibility label uses the supporting text. It reads: UI text (“Please use the company email address”). Role [No role].](../../../assets/images/5044f9c5cfa9-lx32meu7-10.png)
...
![Accessibility label reads: UI text (“Username*”).  The role is “Textbox.”](../../../assets/images/7da5afd51a38-lx32mlzg-11.png)
