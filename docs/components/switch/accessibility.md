...
![The switch handle increases in size when tapped and dragged.](../../../assets/images/d748c57ec7ba-mg68ycaw-01.png)

_Touch: Tap, Drag_

![The cursor changes from an arrow to a hand pointer when hovering over and clicking the switch.](../../../assets/images/2020f5b5c9ce-mg68z1uk-02.png)
...
![Space or Enter is used to toggle the switch off.](../../../assets/images/6a614e175e52-mg692zv4-04.png)
...
![“Dark theme” is the switch’s adjacent label text and the accessibility label.](../../../assets/images/6f4d17ec98aa-mg695w5m-05.png)
...
![The accessibility label for the switch is “Photo album access” though the label text is “photo album.”](../../../assets/images/412c304a2ad5-mg698bn2-06.png)
