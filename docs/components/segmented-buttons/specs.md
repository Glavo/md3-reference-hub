...
_ContainerIcon (optional for unselected state) Label text_
...
_Segmented button color roles used for light and dark schemes:On surfaceOutlineSecondary containerOn secondary container_
...
_Unselected button states:Enabled Disabled Hovered Focused Pressed_

### Selected

![Side by side view of segmented buttons with 4 selected states.](../../../assets/images/8582229b5f74-ma6lbdzb-4b.png)

_Selected button states:Selected Hovered on selectedFocused on selectedPressed on selected_
...
Container width / total segments (Example: 1/3)
