...
![Diagram of 4 badges in different configurations on a navigation bar's destination icons.](../../../assets/images/53dc135c6979-mg0wmkr4-01.png)
...
![Diagram of 4 badges in different configurations on a navigation bar's destination icons.](../../../assets/images/d9e0a3017612-mg0wmphl-02.png)
...
![A small badge is a circle with no characters.](../../../assets/images/a78ee2e31daa-mi46ui92-03.png)

_Small badge_

![A large badge holds 4 characters and expands its container's width but not height.](../../../assets/images/81e54bc113f1-mi46uzu8-04.png)
...
![Number 10 displayed within large badge on a navigation item.](../../../assets/images/d1a9277f07f9-me8jybps-08.png)
...
![Small and large badges on the left side of 2 navigation items in a right-to-left language.](../../../assets/images/7560f8e1c00d-me8k2962-9-do.png)

_Change the position of the badge for right-to-left languages_

![Small and large badges at random positions on 3 icon buttons on a navigation rail.](../../../assets/images/7dffa3adcb6c-me8k2vet-10-dont.png)

_Badges have fixed positions. Don’t change the position of the badge arbitrarily or place the badge over the icon._

![Small and large badges in default red color on 3 navigation items.](../../../assets/images/9fa2d1ebc20a-mg0wr0gz-11_do.png)

_Use the default badge color_

![Small and large badges in custom colors on 3 navigation items.](../../../assets/images/9ca9a02c1543-mg0wr4mw-12_dont.png)
...
![4 icons with increasing number badges. The badges represent quantities, using a "+" symbol for quantities over 999.](../../../assets/images/644f6f2c53f0-me8ks60f-13.png)
...
![4-digit numbers condensed to a 3-digit badge with "+" to fit the badge container's width.](../../../assets/images/5e5ae536d3bf-mg0wrqi2-14_do.png)

_Truncate badge labels as needed_

![4-digit and 5-digit number badges on navigation items exceed the badge container's width and get cut off at the edge.](../../../assets/images/e5eab57c98ff-mg0wru4w-15_dont.png)

_Don’t let the badge get cut off or collide with another element_

## Placement

![Large badge to the right of a navigation rail item.](../../../assets/images/8c4abddcb288-mg0wsl1o-16_do.png)

_Use a large badge to show count information when visual collisions aren’t an issue, such as in a navigation rail_

![Small badge on an icon button in an app bar.](../../../assets/images/ae5a1b931b65-me8kxkle-17_caution.png)
...
![Large badge placed at the end of a tab.](../../../assets/images/b9d30c453989-me8kyp7i-18_do.png)

_When an icon with a badge is followed by text or another element, place a large badge at the trailing edge_

![Large badge overlapping the icon and text in a tab.](../../../assets/images/38faee1b3cdf-me8kzbcm-19_dont.png)
