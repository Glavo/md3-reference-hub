...
![FAB menu measurement annotations. All elements are larger than the minimum target size.](../../../assets/images/ab4ca043c1ea-m0am5xpn-01.png)
...
![FAB menu items are scrolling behind the close button.](../../../assets/images/327e5f61930c-m0am8l9a-02.png)

_Allow the menu items to scroll behind the close button_

![FAB menu items are scrolling in front of the close button.](../../../assets/images/a2530ac1faff-m0am8ym2-03.png)
...
![Accessibility labels for the close button on an Android device.](../../../assets/images/0d1f9d5c1f48-mmmksaup-05.png)
...
![Accessibility labels for a FAB menu item on an Android device.](../../../assets/images/1bcd0a52d929-mmmksh30-06.png)
