...
![On a page of music albums, a FAB menu shows options to make a new playlist, collection, or station.](../../../assets/images/2eb10d966ff3-m0al2scq-01.png)
...
![1 mobile screen with a FAB, 1 with a FAB menu. Both are right aligned.](../../../assets/images/9433aaa1904c-m0al39xa-02.png)
...
![1 mobile screen with a FAB, 1 with a FAB menu. Both are left aligned and mirrored for a right-to-left language.](../../../assets/images/f50661d3e109-m0al3tfx-03.png)
...
![A FAB menu with 5 options on a photo gallery UI.](../../../assets/images/713619816c4e-m0al46l0-04.png)

_FAB menus can have 2-6 items_

![A FAB menu with 1 option on a photo gallery UI.](../../../assets/images/1a6c163bdffc-m0al4jux-05.png)
...
![A toolbar with a FAB directly next to it.](../../../assets/images/58bb18f30f15-m0al73q3-06.png)

_FABs can be placed next to toolbars_

![A toolbar with a FAB menu next to it.](../../../assets/images/611705d18f5d-m0al7run-07.png)
...
![A FAB menu using the primary color set. ](../../../assets/images/b9a38401d6bf-m0al91ki-08.png)
...
![A FAB menu using the secondary color set.](../../../assets/images/71bd24d5beee-m0alljh0-09.png)
...
![A FAB menu using the tertiary color set.](../../../assets/images/ca8583397b51-m0almfyg-10.png)

_A tertiary FAB is paired with a tertiary FAB menu_

## Anatomy

![2 elements of a FAB menu.](../../../assets/images/c496a8e96df6-m0alqq5m-11.png)

_Close buttonList item_

FAB menu items should always have label text. The icons shouldn’t be removed since they make each item easy to identify.

![A FAB menu with 3 options for selecting Food, People, or Nature. There are no icons next to the text.](../../../assets/images/c494663cbbe8-m0alqzgn-12.png)

_Only remove the icon if necessary. The icon provides a differentiation between items._

![A FAB menu with 3 options for selecting Food, People, or Nature. The options are only icons, no text.](../../../assets/images/a70cb0759447-m0feodak-13.png)
...
![A FAB menu used out of the box with no configurations.](../../../assets/images/394c35380e2b-m0alssof-14.png)

_Keep the padding between the container and icon, icon and text, and text and container consistent_

![FAB menu items are equal width despite having different lengths of text.](../../../assets/images/13dc75eaf5c0-m0alt3lp-15.png)

_Don’t expand container sizes_

![FAB menu items are square instead of round.](../../../assets/images/b4c974dd73fd-m0altd3s-16.png)
...
![A FAB menu with 24dp margins from the edge of the window.](../../../assets/images/329cdcdeb0cc-m0alwg82-18.png)
...
![A FAB menu using menu component on web and traditional FAB menu on compact screen.](../../../assets/images/491875f41ffa-mn7ozpxv-18-Web-vs.-Mobile-3P.png)
...
![FAB menu doesn’t obscure actionable element and its focus indicator.](../../../assets/images/95ea9718780b-m4hkgdmm-21.png)

_Ensure the actionable element and its focus indicator are visible behind the FAB menu_

![FAB menu obscures both an actionable element and its focus indicator.](../../../assets/images/22d9f207d48b-m4hkgqnr-22.png)
