...
![The tab button is used to navigate from the first button to the second button in the app bar.](../../../assets/images/aa6417c5da2c-mlos7r6g-04.png)

_Use Tabs to navigate through interactive items_

![The space or enter button activates the second action.](../../../assets/images/1373dbf8e98f-mlos8gq8-05.png)
...
![A search app bar with default dark text on a light container background.](../../../assets/images/6b0fd9d811fe-mlos5etv-06-do.png)

_Make sure search bars and their labels have at least 3:1 contrast. Use the default colors when possible._

![A search app bar with custom light text on a light container background.](../../../assets/images/8953f21dd0c6-mlos65h6-07-dont.png)
...
![The headline has accessibility role “Title”.](../../../assets/images/6157248f9f75-mlos1na5-08.png)
...
![The app bar icon button has the accessibility role “Button”.](../../../assets/images/2a8c28045e38-mlos0avb-09.png)
