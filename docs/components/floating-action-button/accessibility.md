...
![FAB with highly contrasting bright container and dark icon.](../../../assets/images/fa63fb000f1b-malo050e-1.png)

_FAB icons are above the 3:1 contrast ratio_

![FAB with low-contrasting dark container and dark icon.](../../../assets/images/bc648ebecb4a-malo08ew-2.png)
...
![A focused FAB with a tooltip saying “Compose” appearing below it.](../../../assets/images/1e02e1076c2f-mkaqbeez-03.png)
...
![FAB in the lower right region of a small screen.](../../../assets/images/2d0ca3d016c6-mkaqbxv8-04.png)

_In compact windows, place the FAB in the bottom trailing edge_

![FAB in the upper left region of a large screen.](../../../assets/images/e39ff5d8e41c-mkaqcdup-05.png)
...
![FAB in the lower right region doesn’t obscure the focus indicator of an actionable icon.](../../../assets/images/7cc6048b4c82-mkaqcwm1-06.png)

_The FAB can partially cover an actionable element, as long as the focus indicator is still clearly visible_

![FAB in the lower right region obscures an actionable icon and its focus indicator.](../../../assets/images/bb91a4302cde-mkbecw5o-07.png)
...
![Accessibility label and accessibility role of a FAB.](../../../assets/images/32a55d4d1d32-mkaqdy3m-08.png)
