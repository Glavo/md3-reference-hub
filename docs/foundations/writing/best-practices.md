...
source_url: "https://m3.material.io/foundations/writing/best-practices"
lastmod: "2025-09-26"
snapshot_at: "2026-05-21T00:38:04.260Z"
section: "foundations"
assets:
  - "assets/images/3d89a63de9d1-lwj55hv4-8.png"
  - "assets/images/69be356d5fea-lwj5628d-9.png"
  - "assets/images/402ccee957e9-lwj56jdc-10.png"
  - "assets/images/3641daeca697-lwj573aa-7.png"
  - "assets/images/4ab1655f45aa-lwj57nfl-11.png"
---
...
![Stacked card with image, caption, and adjacent text identified.](../../../assets/images/3d89a63de9d1-lwj55hv4-8.png)

_ImageCaptionAdjacent text_
...
![Stacked card with image, alt text as caption, and adjacent text identified.](../../../assets/images/69be356d5fea-lwj5628d-9.png)

_Use captions to help readers understand how the image relates to the content_

### Embedded text in images

Screen readers are unable to read text that is embedded in imagery. If there is essential information embedded as text in the image, include the essential information in the [alt text](../content-design/alt-text.md).

![Stacked card with image, caption overlayed on image, and adjacent text.](../../../assets/images/402ccee957e9-lwj56jdc-10.png)
...
[Learn more about writing alt text](../content-design/alt-text.md)

![A DJ standing in front of music equipment with alt text underneath describing image.](../../../assets/images/3641daeca697-lwj573aa-7.png)

_Use alt text to convey what the image is showing in an informative, short phrase. Alt text example: A DJ performs a set under lights and lasers_
...
![SIM card installation with essential and non-essential elements.](../../../assets/images/4ab1655f45aa-lwj57nfl-11.png)

_The illustration contains both essential and non-essential information:Essential: The text meets all contrast ratios and size requirementsEssential: An illustrative visual representation of the instructions that follows color contrast guidelinesNon-essential: The decorative elements create background and personality for the illustration. They do not relay information and do not have to meet Material's contrast requirements._
