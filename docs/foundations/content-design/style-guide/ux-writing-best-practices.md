...
assets:
  ...
  - "assets/images/42db2593b119-lvw0g6jb-2_don't.png"
  - "assets/images/d0ce36621bfa-lvw0gqx5-3.png"
  - "assets/images/a7e272d6811b-lvw0hrme-4_do.png"
  - "assets/images/b72811e611d8-lvw0i4xj-5_don't.png"
  - "assets/images/c93780d459de-lvw0j9q3-6_do.png"
  - "assets/images/c521fda05a5c-lvw0jnlb-7_don't.png"
---
...
!["Move to trash?" dialog with the message "Big birthday bash will be deleted after 30 days."](../../../../assets/images/076bb8262671-lvw0frl1-1_do.png)

_Tell users what will happen if they take an action and how they can undo it_

!["Are you sure you want to move to trash?"dialog with the message "You'll be able to find "Big birthday bash" in your trash for 30 days."](../../../../assets/images/42db2593b119-lvw0g6jb-2_don't.png)
...
![Easily scannable content with different headings and subheadings on a card.](../../../../assets/images/d0ce36621bfa-lvw0gqx5-3.png)
...
![Sentence-style capitalization used for the title and consequence statement  in a dialog.](../../../../assets/images/a7e272d6811b-lvw0hrme-4_do.png)

_Capitalize the first word of a sentence or phrase_

![Title casing used for the title  in a dialog.](../../../../assets/images/b72811e611d8-lvw0i4xj-5_don't.png)
...
![AM and PM abbreviations used on a clock app.](../../../../assets/images/c93780d459de-lvw0j9q3-6_do.png)

_When an abbreviation is appropriate, make sure it’s formatted and spelled correctly to avoid confusion_

![Abbreviations used for months and days on buttons when there is enough space to spell them out.](../../../../assets/images/c521fda05a5c-lvw0jnlb-7_don't.png)
