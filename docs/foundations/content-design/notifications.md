...
![Image](../../../assets/images/fc3c24363406-lw53k6lt-1.png)
...
![Three notifications from Google apps that include the point of the notification in the header.](../../../assets/images/f8defb8b824d-lw53kfhk-2.png)

_Prioritize the most important information_

![Three notifications from Google apps that include app names repeated in the header, instead of important information.](../../../assets/images/b08ea6699147-lw53kk0k-3.png)
...
![A Google maps notification in Memphis, TN that’s personalized to the user’s location downtown.](../../../assets/images/612db39d4adf-lw53l2ot-6.png)

_Be specific to capture user attention_

![A Google maps notification in Memphis, TN that’s generic to the city, rather than the area.](../../../assets/images/4c35b04398ad-lw53l86v-7.png)
...
![Two notifications, one with dynamic text in the body, and the other with dynamic text in the header that’s formatted to always be short.](../../../assets/images/51575623c392-lw53lep9-8.png)
...
![Two notifications with dynamic text in the header that’s too long and truncates.](../../../assets/images/79d7486ea615-lw53lk9g-9.png)
...
![A short, relevant, and informative notification.](../../../assets/images/1b81d8f15a2a-lw53ls3l-10.png)
...
![An SMS notification that’s brief and truncates sensitive information.](../../../assets/images/60ea5a2792ac-lw53lzfr-11.png)

_SMS messages should be brief and important_

![An SMS notification that’s too long with too many links.](../../../assets/images/a51b9e71c186-lw53m528-12.png)
...
![A notification about coffee with a coffee emoji at the end of the header.](../../../assets/images/d68b4b65c191-lw53mcby-13.png)

_Use emoji only to enhance a message_

![A notification about high traffic volume on a route to work that uses upset emoji. A notification about coffee that substitutes a coffee emoji for the word “coffee.”](../../../assets/images/c18301710107-lw53mhmr-14.png)
...
![Image](../../../assets/images/139bc196aa19-lw53n553-17.png)

_Specify the day of the week so that it makes sense if someone reads it the following day_

![Image](../../../assets/images/333e7a793394-lw53nb80-18.png)
...
![Image](../../../assets/images/0cf58d7c294a-lw53nkf2-19.png)
...
![Image](../../../assets/images/1d9da28afd68-lw53ntem-20.png)

_Use the available space for useful information_

![Image](../../../assets/images/d18f55a72f5c-lw53nz6w-21.png)
...
![Image](../../../assets/images/0d8d84dd5cd3-lw53o6jr-22.png)
