...
![Examples of outlined symbols with stroke and fill attributes.](../../../assets/images/0bb108f96569-mltewg4l-3p-icons-simple-sm.png)

_Outlined style_

![Outlined icon set on grid.](../../../assets/images/8e92ae203632-mlteyie2-3p-icons-simple-sm-(1).png)

_2dp outlined icons remain readable across sizes and applications_

![Four filled symbols showing full body human and proprietary icons.](../../../assets/images/8544af5780ba-mltezfir-3p-icons-simple-sm-(2).png)
...
![Thin-lined outlined symbols correspond to app typography.](../../../assets/images/1e67d76e8b16-mltf0cys-3p-icons-simple-sm-(3).png)
...
![Examples of rounded-style icons.](../../../assets/images/960bb44737fd-mltf1xps-3p-icons-simple-sm-(4).png)

_Rounded-style icons_

![Examples of sharp-style icons.](../../../assets/images/a2d6f354a5a8-mltf2lz3-3p-icons-simple-sm-(5).png)

_Sharp-style icons_

![Plus icon as a round icon.](../../../assets/images/1a2c9f952901-mltf3wv6-3p-icons-simple-sm-(6).png)

_Corner radii for round icons_

![Plus icon as a sharp icon.](../../../assets/images/8be994fb0254-mltf4gzj-3p-icons-simple-sm-(7).png)

_Square corner radii for sharp icons_

![Travel app with rounded buttons and rounded icons.](../../../assets/images/a11b027f9dbb-mltf5q1f-3p-icons-rounded.png)

_This app uses rounded buttons and round icons_

![Six icons implementing sharp style.](../../../assets/images/acd07aa19dd2-mltf6rl4-3p-icons-sharp.png)
...
![400 regular-weight icons used in standard navigation drawer and modal navigation drawer.](../../../assets/images/b1d0b3c4d7a7-mltfgz8n-4.png)

_400 regular-weight symbols_

![Photo gallery using 100 weight icons.](../../../assets/images/fe729f678abb-mltfibed-5.png)

_Don't use the lightest weight for standard-size (24dp) icons. The minimum weight for this size should be 200._

![Three side-by-side 24p standard symbols.](../../../assets/images/bb4ed129e4ff-mltfjhty-6.png)

_Be careful using excessive weight for standard 24dp symbols_

![Navigation rail with consistent symbol weights.](../../../assets/images/460dd49bf18e-mltfkfrj-7.png)

_Apply weights consistently_

![Navigation rail with varying symbol weights.](../../../assets/images/158bdaa31b28-mltfkvco-8.png)
...
![Unfilled icons.](../../../assets/images/279551c72edf-mltfngpy-9.png)

_Unfilled symbols with fill set to 0_

![Set of filled icons.](../../../assets/images/a048285139e2-m0zq1u30-10.png)
...
![Button with icon and text in light UI.](../../../assets/images/30548cadc8fc-mltfs7t4-13.png)

_Icon button featuring a 0 default grade symbol in light UI_

![Button with icon and text in dark UI.](../../../assets/images/d21edb2d6c47-mltfsk4i-14.png)
...
![Photo icon in active state appearing bolder.](../../../assets/images/987e15dd83f6-mltftgny-15.png)
...
![Four icons gradually increasing in optical size.](../../../assets/images/3a965331b45f-mltfunii-16.png)
...
![Desktop dropdown menu with icon in active state.](../../../assets/images/b203713d53a9-mlhj7jch-18.png)

_Use 20dp optical size value for dense layouts on desktop_

![Forward and reverse symbols highlighted on device.](../../../assets/images/5bd4b921944c-mlhj7te6-19.png)
...
![Selections of icons and typography examples in different contexts where weights and sizes are paired.](../../../assets/images/4c0fb8574524-mltfz81y-29-alt.png)

_Match the optical weight and size of text and icon to ensure consistency_

![Text and icon that are the same size.](../../../assets/images/7bafe4244384-mlhjbtka-30-do.png)

_Use the same size for your Material Symbols and text_

![A small icon mismatched with larger text.](../../../assets/images/3241441c91e7-mlhjcgls-31-dont.png)

_Don’t mix the sizes of your symbol and text_

![An icon and text that are the same optical weight.](../../../assets/images/97b4091ed000-mlhjcu6l-21-do.png)

_Use the same optical weight for your symbol and text_

![An icon and text that have mismatched optical weight.](../../../assets/images/302c360ae352-mlhjd06m-22-dont.png)

_Don’t use different optical weights for Material Symbols and text_

![Icon that has had its baseline shifted down 11.5%.](../../../assets/images/48afa95a2f14-mlhjdahx-23.png)

_Shift down the baseline of symbols to approximately 11.5% of the text size_

![Icon and text that are using the same baseline.](../../../assets/images/589d71d9f3c5-mlhjdnhz-24.png)
...
![Navigation bar showing four destinations, with 1 active destination featuring both icon and text label.](../../../assets/images/3376d518bb7d-mltg9l6i-25.png)

_Label text provides short descriptions, especially useful for navigation_

![Navigation bar with four destinations with only icons, no labels.](../../../assets/images/7c00731216cb-mltgabid-26.png)
...
![Comparison of three UIs showing add to cart, add to bag, and add to basket.](../../../assets/images/658986e43d26-mlthlq1i-Icons-localizing.png)
...
![Comparison of UIs where red and green are warning colors.](../../../assets/images/cd201a017242-mlthn4xa-Colors-localizing.png)
