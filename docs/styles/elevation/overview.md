...
_Elevation represents the distance between elements. The product applies color to represent elevation.One surface at 1dp elevation and another surface at 8dp elevation, as viewed from the frontThe difference in elevation between the two surfaces is 7dp, as viewed from the side_
