...
assets:
  ...
  - "assets/images/5af53fcab0e5-lwyl9cz5-2.png"
  - "assets/images/218777c15667-lwynetr7-3.png"
  - "assets/images/2eb7cd23f912-lwynhr1z-5_do.png"
  - "assets/images/22c31c043571-lwyni1qa-4_dont.png"
  - "assets/images/6be86f2f9297-lwynjnhh-6.png"
  - "assets/images/45748a283c42-lwynkcgy-7.png"
  - "assets/images/46c22bb4b7e0-lwynkpp5-8.png"
  - "assets/images/a4d8abf05256-lwynle77-9.png"
  - "assets/videos/11579d93650d-lwynmywr-GM3-Styles-Elevation-Applying_Elevation-1-v01.mp4"
  - "assets/images/27f098cd2892-lwynlv1e-11.png"
---
...
![Diagram showing the 5 elevation levels and their respective dp values.](../../../assets/images/fed7916d81ed-lwyl8vgl-1.png)
...
![FAB separated from the surface beneath it using a shadow.](../../../assets/images/2eb7cd23f912-lwynhr1z-5_do.png)

_Ensure floating elements have sufficient contrast with surfaces beneath_

![FAB without shadows, insufficiently separated from the surface beneath it.](../../../assets/images/22c31c043571-lwyni1qa-4_dont.png)
...
![Podcast app with each show displayed as a card separated from the background using small dark shadows.](../../../assets/images/45748a283c42-lwynkcgy-7.png)

_Smaller, sharper shadows indicate a surface’s close proximity to the surface behind it_

![Podcast app with each show displayed as a card separated from the background using more fuzzy and diffused shadows.](../../../assets/images/46c22bb4b7e0-lwynkpp5-8.png)
...
![Buttons with shadows separating them from a background image.](../../../assets/images/a4d8abf05256-lwynle77-9.png)
...
![Large screen news app with a navigation rail separated from the body content by a scrim.](../../../assets/images/27f098cd2892-lwynlv1e-11.png)
