...
![Example display typeface.](../../../assets/images/19dd6838c7f9-macjmd1h-01.png)

_An expressive typeface can be used for display styles, as shown here with Bagel Fat One_

![Card featuring display size font.](../../../assets/images/60566708a569-macjqddd-02.png)

_A card using a display size_

![Large expressive typeface set above text.](../../../assets/images/28ff80e8eee4-macjwt1d-03.png)
...
![Example expressive headline typeface on phone screen.](../../../assets/images/f4fa56b2614f-macjyz7x-04.png)

_Expressive typefaces can be used for headlines styles as well, as shown here with Anton_

![The name Ana Russo in headline style in a contact card.](../../../assets/images/edbc13237f87-mack0w9r-05.png)

_Headline style used for short text on a small screen_

![Headline style set above body text.](../../../assets/images/beef588e9261-mack28hn-06.png)
...
![An article card using title style for the article title.](../../../assets/images/0bb95c840acb-mack408c-07.png)

_A news article title using the title style to capture attention, as shown here with Bebas Neue_

![Top app bar using title style for the contact name, Aki Aro.](../../../assets/images/3e4749d76e89-mack6viy-08.png)

_App bar using title style_

![Title style stating ‘Top News’ above headlines.](../../../assets/images/ab9ccec260e1-mack8igb-09.png)
...
![Body-style typeface.](../../../assets/images/03be1e52283e-mackbvpu-10.png)

_Body styles must be readable for long passages_

![Body style text in article.](../../../assets/images/62d09078f105-mackfzlx-11.png)

_Body style used throughout an article about pesto_

![Three stacked examples of body style in app setup flow.](../../../assets/images/d75f4db961d8-mackjtaf-12.png)
...
![Several label-style buttons on compact window.](../../../assets/images/fafdb35b7ab7-m845h3dq-13-3P.png)

_Label styles should enable quick reading at small sizes, such as in buttons_

![Music player timecode featuring label style.](../../../assets/images/f5409d004646-mackqp3j-14.png)

_A music player using label style for the timecode_

![Five labels set horizontally across the navigation bar.](../../../assets/images/9ebc511314fc-mafuf50h-15.png)
...
![Diagram of bounding box equaling line height.](../../../assets/images/bd5bd1654a7a-mackyuk9-16.png)
...
![Diagram of 20 dp padding above text.](../../../assets/images/b4ee49b08420-macl0ia5-17.png)
...
![Measurements of label text padding.](../../../assets/images/2a7622f2aa0e-macl33y5-18.png)
...
![Diagram indicating the baseline of text.](../../../assets/images/8a05cef02df4-macldncz-20.png)
...
![Diagram of the distances between overline and container edge, plus subhead, overline, and caption text.](../../../assets/images/6c16d19e7104-mafug7pc-21.png)
...
![An example of larger type with a line height ratio of 1.2](../../../assets/images/4aaf5a22c9f1-macludjq-23.png)
...
![An example of body type with a line height ratio of 1.5.](../../../assets/images/77bcb0908fb9-maclv7q4-24.png)
...
![Contrast between two colors, quantified by a contrast ratio, supports visual accessibility.](../../../assets/images/23313a43ccb2-madkak1u-27.png)
...
![Large text should achieve a contrast ratio of 3:1.](../../../assets/images/28885a0ff6e1-madpdpks-28.png)

_Large text should achieve a contrast ratio of 3:1_

![Small text should achieve a contrast ratio of 4.5:1.](../../../assets/images/393d5816e400-madpf3uf-29.png)
...
![Diagram showing the default color for text is "on surface."](../../../assets/images/aacad0da0a30-madpks74-30.png)
...
![In a paragraph, md.sys.color.primary color is applied to an underlined hyperlink. ](../../../assets/images/0f79b8ea3675-madprtta-31.png)
