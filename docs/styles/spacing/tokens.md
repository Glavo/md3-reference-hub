...
![The spacing system tokens, built from 8dp (1x). The range covers 0x to 9x.](../../../assets/images/b67529c78f72-mp47oayx-01.png)
...
![The spacing system defines tokens for 0.25x, 0.5x, 0.75x. 1.25x nested units.](../../../assets/images/cabf75b9d480-mp47p71x-01.png)
