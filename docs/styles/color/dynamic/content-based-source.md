...
-   Android Views (MDC-Android) – [Content-based dynamic color](https://github.com/material-components/material-components-android/blob/master/docs/theming/Color.md#content-based-dynamic-colors)
